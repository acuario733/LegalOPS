...
return [
    'superadmin' => [
        ...
        'superadmin_usuarios.ver', 'superadmin_usuarios.crear',
        'superadmin_usuarios.editar', 'superadmin_usuarios.desactivar',
        'superadmin_usuarios.reactivar', 'superadmin_usuarios.resetear_password',
        'superadmin_roles.ver', 'superadmin_roles.crear',
        'superadmin_roles.editar', 'superadmin_roles.asignar',
    ],
    'firma' => [
        'perfil.ver', 'perfil.editar', 'perfil.cambiar_password',
