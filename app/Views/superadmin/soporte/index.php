...
<div class="card" data-module="soporte-global">
    ...
    <div class="table-responsive">
        <table class="table align-middle mb-0">
            <thead><tr><th>Firma</th><th>Ticket</th><th>Prioridad</th><th>Estado</th><th>SLA</th><th></th></tr></thead>
            <tbody>
            <?php foreach ($tickets as $ticket): ?>
                <tr>
                    ...
                    <td class="small text-secondary">Resp: <?= e($ticket['primera_respuesta_due_at'] ?? '') ?><br>Sol: <?= e($ticket['solucion_due_at'] ?? '') ?></td>
            ...
            <?php endforeach; ?>
            <?php if ($tickets === []): ?><tr><td colspan="6" class="text-center text-secondary py-4">No hay tickets globales.</td></tr><?php endif; ?>
            </tbody>
        </table>
    </div>
</div>
