    ...
    <div class="col-xl-4">
        <div class="card"><div class="card-header"><h2 class="card-title">Nueva audiencia</h2></div><div class="card-body">
            <form action="/audiencias" method="post" data-ajax-form>
                <div class="mb-2"><label class="form-label">Caso</label><select class="form-select" name="caso_id" required><option value="">Seleccione</option><?php foreach ($casos as $caso): ?><option value="<?= (int) $caso['id'] ?>"><?= e($caso['titulo']) ?></option><?php endforeach; ?></select></div>
