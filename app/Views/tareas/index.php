    ...
    <div class="col-xl-4">
        <div class="card"><div class="card-header"><h2 class="card-title">Nueva tarea</h2></div><div class="card-body">
            <form action="/tareas" method="post" data-ajax-form>
                ...
                <div class="mb-2"><label class="form-label">Termino vinculado</label><select class="form-select" name="termino_id" data-ajax-select data-url="/api/select/terminos" data-parent-field="caso_id" data-parent-param="caso_id" data-empty-label="Sin termino"><option value="">Sin termino</option></select></div>
